...
function ProductCard({
  ...
  onOpen: (p: typeof PRODUCTS[0], initialSizeIndex?: number) => void
}) {
  return (
    <div
            ...
            {reviews.length === 0 ? (
              <div className="flex-1 flex flex-col items-center justify-center text-center p-8 bg-[#FBF8F2] rounded-2xl border border-[#E0D8CC] border-dashed">
                ...
                <p className="text-xs text-[#7A6A58] mt-1 max-w-xs leading-relaxed">
                  Be the first to review one of our soaps! Fill out the form on
                  the left to save your feedback in our database.
                </p>
              </div>
            ) : (
...
export default function App() {
  ...
  const [activeProduct, setActiveProduct] = useState<typeof PRODUCTS[0] | null>(
    null,
  )
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div>
              ...
              >
                ...
                wholesale orders? Or prefer ordering directly over call or
                WhatsApp? We are always here to help you.
              </p>
            ...
            <div className="bg-[#3A5C3E] p-8 rounded-2xl text-[#F7F2E9] relative overflow-hidden shadow-lg flex flex-col justify-between min-h-[390px]">
              ...
              <div className="border-t border-[#8FAF7E]/20 pt-4 mt-4">
                <p className="text-[10px] font-bold text-[#C8A97E] uppercase tracking-widest mb-2.5">
                  How It Works
                </p>
                <ol className="flex flex-col gap-3 text-xs text-[#C8D8C2] list-decimal pl-4 leading-relaxed font-light">
                  ...
                  <li>
                    A pre-filled message will open directly in your chat
                    application.
                  </li>
                  <li>
                    Confirm your shipping details and complete payment to
                    confirm your order.
                  </li>
                </ol>
              </div>
