          ...
          <div>
            ...
            {ratingInfo !== undefined && (
              <div className="flex items-center gap-2 mt-1.5">
                  ...
                  {[1, 2, 3, 4, 5].map((s) => (
                    <svg
                      ...
                      className={`w-3.5 h-3.5 fill-current ${
                        ratingInfo.count > 0 && s <= Math.round(ratingInfo.avg)
                          ? "text-yellow-400"
                          : "text-[#D9D0C0]"
                      }`}
                      viewBox="0 0 20 20"
                ...
                {ratingInfo.count > 0 ? (
                  <span className="text-xs font-semibold text-[#5A4A38]">
                  ...
                  <span className="text-xs italic text-[#8A7A68]">No reviews yet — be the first!</span>
                )}
              </div>
            )}
            <p
