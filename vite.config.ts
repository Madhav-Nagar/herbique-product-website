...
try {
  ...
  console.warn("Could not load site configuration from .figma/make/site.json, using default configuration.")
}
...
function figmaSiteConfiguration(config: FigmaSiteConfiguration): Plugin {
  ...
  const title = config.title ?? "Herbique - Premium Natural Soaps"
